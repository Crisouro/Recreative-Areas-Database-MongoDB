...
def cleanse_area(df_data, to_process: dict, parser: dict, df)-> None:
    ...
    cf.clean_null("ID", df_data, to_process['n_columns'], parser['null_values'], df)
...
def cleanse_mantenimiento(df_data, to_process: dict, parser: dict, df)-> None:
...
def cleanse_usuarios(df_data, to_process: dict, parser: dict, df)-> None:
    cf.clean_duplicates("usuarios", df, to_process["unique_id"], parser["unique_id"])
    cf.clean_null("NIF", df_data, to_process['n_columns'], parser['null_values'], df)
    df.to_csv(os.path.join("cleaned", "UsuariosLimpio.csv"), header=True, sep=',', index=False)

def cleanse_juegos(df_data, to_process: dict, parser: dict, df)-> None:
...
def cleanse_meteo(df_data, to_process: dict, parser: dict, df)-> None:
    pass
